...
-----------
 ...
 :param showall: str
 :param filetypes: str
 :param filesexclude: str
 :param filesinclude: str
 :param filetypesexclude: str
 :param direxclude: str
 :param fileshelp: str


 :return: str
    Directory hierarchy of the standardized file system structure (FSS)
 """
    ...
    for item in files:
        ...
        if (item.endswith((".png", ".jpg", ".jpeg", ".svg", ".gif"))):  # images should be open in separate
            ...
            new_item_path = md2html(fsspath, navdir, item_path, item) #points to html in .navigate
...
#end function clear_navigate


# Funtion: get_ranodm_string
